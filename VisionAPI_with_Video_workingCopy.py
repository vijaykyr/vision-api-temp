...
if __name__ == '__main__':
  parser = argparse.ArgumentParser(description='Feed a video to the Google Vision API')
  parser.add_argument(
    'video_file', help='The video you\'d like to process.')
  parser.add_argument(
    'APIKey', help='The API Key that identifies your Google Cloud Console Project with Vision API Enabled')
  args = parser.parse_args()
  main(args.video_file,args.APIKey)